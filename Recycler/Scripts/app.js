...
function sendMailThenGoToMyStuff(name, recipients, context) {
    var attributes = {
        "Recipients": recipients,
        "Context": context
    };
...
function TranslateGpsError() {
    //Por favor, active GPS de usar-esta aplicaci�n.
    ...
    switch (localStorage.Language) {
        ...
        case "4":
            return "Por favor, active GPS de usar-esta aplicaci�n.";
